...
export interface ConstructFn {
  ...
  <A, B, C, D, E, F, R>(f: { new (a: A, b: B, c: C, d: D, e: E, f: F): R }): Curry6<
    A,
    B,
    C,
    D,
    ...
    R
  >
  <A, B, C, D, E, F, G, R>(f: { new (a: A, b: B, c: C, d: D, e: E, f: F, g: G): R }): Curry7<
    A,
    B,
    C,
    D,
  ...
  >
  <A, B, C, D, E, F, G, H, R>(f: {
    new (a: A, b: B, c: C, d: D, e: E, f: F, g: G, h: H): R
  }): Curry8<A, B, C, D, E, F, G, H, R>
  <A, B, C, D, E, F, G, H, I, R>(f: {
    new (a: A, b: B, c: C, d: D, e: E, f: F, g: G, h: H, i: I): R
  }): Curry9<A, B, C, D, E, F, G, H, I, R>
  // tslint:disable-next-line:max-line-length
  <A, B, C, D, E, F, G, H, I, J, R>(f: {
    new (a: A, b: B, c: C, d: D, e: E, f: F, g: G, h: H, i: I, j: J): R
...
export const construct: ConstructFn = function construct<A>(f: { new (...args: Array<any>): A }) {
  ...
  function curried(previousArgs: Array<any>) {
    return function(...args: Array<any>) {
      ...
      if (concatArgs.length >= length) return new f(...concatArgs)
