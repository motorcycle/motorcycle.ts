export interface AssocArity3 {
  <A extends object, B>(path: string, value: B, obj: A): Readonly<A> &
    { readonly [S in typeof path]: B }
...
export type AssocArity1<A extends object, P extends string, B> = (
  obj: A
) => Readonly<A> & { readonly [S in P]: B }
