export interface ReduceByArity4 {
  <A, B>(f: (acc: B, value: A) => B, seed: B, by: (a: A) => string, list: Array<A>): {
    readonly [key: string]: B
  }
  <A, B>(f: (acc: B, value: A) => B, seed: B, by: (a: A) => string, list: ArrayLike<A>): {
    readonly [key: string]: B
  }
  <A, B>(f: (acc: B, value: A) => B, seed: B, by: (a: A) => string, list: ReadonlyArray<A>): {
    readonly [key: string]: B
  }
