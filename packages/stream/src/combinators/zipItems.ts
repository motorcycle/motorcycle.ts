 ...
 *
 * @name zipItems<A, B, C>(f: (arrayValue: A, streamValue: Stream<B>) => C, array: Array<A>, stream: Stream<B>): Stream<C>
 * @example
 * import { zipItems, now, concat, observe } from '@motorcycle/stream'
 *
 * const f = (x, y) => x + y
 *
 * const array = [ 100, 200 ]
 ...
 *
 * observe(console.log, zipItems(f, array, stream))
 * // 101
 * // 202
 */
export { zipItems } from '@most/core'
