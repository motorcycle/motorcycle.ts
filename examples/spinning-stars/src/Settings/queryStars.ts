...
import { STARS_INPUT_CSS_CLASS } from './view'
import { Stream } from '@motorcycle/types'
import { map } from '@motorcycle/stream'

export function queryStars(dom: DomSource): Stream<NonnegativeInteger> {
  const starsCount = query(`.${STARS_INPUT_CSS_CLASS}`, dom)
